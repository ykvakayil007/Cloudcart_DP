...
const banner = {
  background: "url({supermarket}) no-repeat center center",
...
ReactDOM.render(
  <div>
    <div className="banner text-center" style={banner}>
      <img src={logo} height="150px" width="1000px" alt="logo" style = {{marginLeft :"20px"}}/>
      <br />
      <br />
      <br />
      <div className="container">
        <div className="row">
          <div className="banner_content">
            ...
            <button className="cmn_btn" style={cmn_btn}>
              Register
            </button>{" "}
            <button className="cmn_btn" style={cmn_btn}>
              Login
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6">
            <img src= {corona} alt="corona" style = {{height :"270px"}} />
          </div>
